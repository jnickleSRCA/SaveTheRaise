        ...
        <div style={{ marginBottom: '20px' }}>
          <label>
            ...
            <input
              ...
              onChange={(e) => setFormData({ ...formData, dollar_value: e.target.value })}
              required
              style={{ width: '100%', padding: '8px', marginTop: '5px' }}
            />
          </label>
            ...
            <div style={{ marginBottom: '20px' }}>
              <label>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, old_cost: e.target.value })}
                  required
                  style={{ width: '100%', padding: '8px', marginTop: '5px' }}
                />
              </label>
            ...
            <div style={{ marginBottom: '20px' }}>
              <label>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, new_cost: e.target.value })}
                  required
                  style={{ width: '100%', padding: '8px', marginTop: '5px' }}
                />
              </label>
