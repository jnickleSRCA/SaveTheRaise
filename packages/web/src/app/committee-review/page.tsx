...
export default function CommitteeReview() {
    ...
    return (
      <>
        ...
        <div style={{ padding: '40px 20px', maxWidth: '900px', margin: '0 auto' }}>
          ...
          >
            <h1 style={{ color: '#006994', marginBottom: '30px', fontSize: '2em' }}>
              ✏️ Edit Idea
            </h1>
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditFormData({
                          ...editFormData,
                          area_to_improve: e.target.value,
                        })
                      }
                      style={{ width: '100%', padding: '8px', marginTop: '5px' }}
                    />
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      committee_review: { label: 'Under Review', bg: '#FFC107', color: '#000' },
      approved: { label: 'Approved', bg: '#28a745', color: '#fff' },
      implemented: { label: 'Implemented', bg: '#FF8C00', color: '#fff' },
      rejected_committee: { label: 'Rejected', bg: '#dc3545', color: '#fff' },
    };
    ...
    <>
      ...
      <div style={{ padding: '40px 20px', maxWidth: '1400px', margin: '0 auto' }}>
        <h1 style={{ color: '#006994', marginBottom: '30px', fontSize: '2.2em' }}>
          ⭐ Committee Review - All Submissions
        </h1>
          ...
          >
            {ideas.map((idea) => (
              ...
              >
                ...
                >
                  {idea.submitter_names}
                </div>

                <div style={{ marginBottom: '8px', fontSize: '0.9em', color: '#666' }}>
                  {idea.type === 'part_change' ? '🔧 Part Change' : '⚙️ Process Change'}
                </div>
                ...
                {idea.type === 'part_change' && (
                  <div
                    style={{ marginBottom: '12px', fontSize: '0.9em', lineHeight: '1.5' }}
                  >
                    <div>
                      <strong>Old:</strong> {idea.old_pn} (${idea.old_cost})
                    </div>
                    <div>
                      <strong>New:</strong> {idea.new_pn} (${idea.new_cost})
                    </div>
                    <div>
                ...
                {idea.type === 'process_change' && (
                  ...
                  >
                    <div>
                      <strong>Area:</strong> {idea.area_to_improve}
                    </div>
                    <div>
                      <strong>Affects:</strong> {idea.customers_affected}
                    </div>
                  </div>
                )}
